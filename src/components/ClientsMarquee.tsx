...
const clients = [
  ...
  { name: "Sun Pharma", domain: "sunpharma.com", color: "#F7931E" },
  { name: "Lupin", domain: "lupin.com", color: "#E31837" },
  { name: "Aurobindo", domain: "aurobindo.com", color: "#1E4D8C" },
  { name: "Zydus", domain: "zyduslifesciences.com", color: "#00A651" },
  { name: "Torrent", domain: "torrentpharma.com", color: "#E21937" },
  { name: "Glenmark", domain: "glenmarkpharma.com", color: "#0072BC" },
  { name: "Alkem", domain: "alkemlabs.com", color: "#ED1C24" },
  { name: "Biocon", domain: "biocon.com", color: "#0072BB" },
  { name: "Hetero", domain: "heteroworld.com", color: "#00A859" },
  { name: "Natco", domain: "natcopharma.com", color: "#1C4587" },
  { name: "Wockhardt", domain: "wockhardt.com", color: "#E31E24" },
  { name: "Ipca Labs", domain: "ipcalabs.com", color: "#003F87" },
  { name: "Divis Labs", domain: "divislabs.com", color: "#1E3A8A" },
];
...
function ClientLogo({ client }: { client: (typeof clients)[0] }) {
  ...
  const logoUrl = `https://img.logo.dev/${client.domain}?token=pk_X-1ZO13GSgeOoUrIuJ6GMQ&size=120&format=png`;
...
export default function ClientsMarquee() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-16 lg:py-24 bg-gradient-to-b from-background via-muted/20 to-background overflow-hidden"
    >
